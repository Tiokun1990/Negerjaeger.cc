...
namespace Settings
{
	void LoadSettings(string szIniFile)
	{
		...
		Aimbot::aim_Backtracktickrate = CSX::Cvar::LoadCvar(AIMBOT_TEXT, CVAR_AIMTBOT_BACKTRACKTICKRATE, Aimbot::aim_Backtracktickrate);
		...
		string esp_Color_CT = CSX::Cvar::LoadCvar(VISUAL_TEXT, CVAR_ESP_COLOR_CT, "255,0,0");
		string esp_Color_TT = CSX::Cvar::LoadCvar(VISUAL_TEXT, CVAR_ESP_COLOR_TT, "255,0,0");

		string esp_Color_VCT = CSX::Cvar::LoadCvar(VISUAL_TEXT, CVAR_ESP_COLOR_VCT, "0,255,0");
		string esp_Color_VTT = CSX::Cvar::LoadCvar(VISUAL_TEXT, CVAR_ESP_COLOR_VTT, "0,255,0");
		...
		string chams_Color_VCT = CSX::Cvar::LoadCvar(VISUAL_TEXT, CVAR_CHAMS_COLOR_VCT, "0,165,255");
		string chams_Color_VTT = CSX::Cvar::LoadCvar(VISUAL_TEXT, CVAR_CHAMS_COLOR_VTT, "0,165,255");
	...
	void SaveSettings(string szIniFile)
	{
		...
		CSX::Cvar::SaveCvar(AIMBOT_TEXT, CVAR_AIMTBOT_BACKTRACKTICKRATE, Aimbot::aim_Backtracktickrate);
