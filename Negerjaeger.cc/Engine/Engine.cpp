...
//[junk_disable /]
	...
	void ClanTag()
	{
		...
		case 1:
		{
			SetMyClanTag("Negerjaeger.cc", "Negerjaeger.cc");
			break;
		}
		...
		case 2:
		{
			...
			case 1:
			{
				SetMyClanTag("\u534D N", "Animation");
				break;
			}
			case 2:
			{
				SetMyClanTag("\u5350 Ne", "Animation");
				break;
			}
			case 3:
			{
				SetMyClanTag("\u534D Neg", "Animation");
				break;
			}
			case 4:
			{
				SetMyClanTag("\u5350 Nege", "Animation");
				break;
			}
			case 5:
			{
				SetMyClanTag("\u534D Neger", "Animation");
				break;
			}
			case 6:
			{
				SetMyClanTag("\u5350 Negerj", "Animation");
				break;
			}
			case 7:
			{
				SetMyClanTag("\u534D Negerja", "Animation");
				break;
			}
			case 8:
			{
				SetMyClanTag("\u5350 Negerjae", "Animation");
				break;
			}
			case 9:
			{
				SetMyClanTag("\u534D Negerjaeg", "Animation");
				break;
			}
			case 10:
			{
				SetMyClanTag("\u5350 Negerjaege", "Animation");
				break;
			}
			case 11:
			{
				SetMyClanTag("\u534D Negerjaeger", "Animation");
				break;
			}
			case 12:
			{
				SetMyClanTag("\u5350 Negerjaeger.", "Animation");
				break;
			}
			case 13:
			{
				SetMyClanTag("\u534D Negerjaeger.c", "Animation");
				break;
			}
			case 14:
			{
				SetMyClanTag("\u5350 Negerjaeger.cc", "Animation");
				break;
			}
			case 15:
			{
	...
	{
		std::vector<std::string> chatspam = { "Negerjaeger.cc > ALL" };
	...
	void ChatSpamRandom()
	{
		std::vector<std::string> chatspamsss = { "Negerjaeger.cc OWNS ME AND ALL!" , "get good get Negerjaeger.cc" , "Negerjaeger.cc by UeberfahreNN Crew" , "UeberfahreNN du NN" , "Negerjaeger.cc MM Dominator","Surrender or Buy Negerjaeger.cc","Rolle Ueber MM wie ein Lastwagen" };
	...
	{
		SetMyClanTag(TagName, "Negerjaeger.cc");
	}
