...
void CGui::MenuColor()
{
	...
	style.Colors[ImGuiCol_FrameBgHovered] = ImVec4(0.92f, 0.12f, 0.12f, 0.57f);
	style.Colors[ImGuiCol_FrameBgActive] = ImVec4(0.98f, 0.26f, 0.26f, 1.00f);
	style.Colors[ImGuiCol_TitleBg] = ImVec4(0.65f, 0.00f, 0.00f, 1.00f);
	style.Colors[ImGuiCol_TitleBgActive] = ImVec4(0.65f, 0.00f, 0.00f, 1.00f);
	...
	style.Colors[ImGuiCol_SliderGrab] = ImVec4(0.62f, 0.62f, 0.62f, 1.00f);
	style.Colors[ImGuiCol_SliderGrabActive] = ImVec4(0.08f, 0.08f, 0.08f, 1.00f);
	style.Colors[ImGuiCol_Button] = ImVec4(0.65f, 0.00f, 0.00f, 1.00f);
	...
	style.Colors[ImGuiCol_Header] = ImVec4(0.65f, 0.00f, 0.00f, 1.00f);
	style.Colors[ImGuiCol_HeaderHovered] = ImVec4(0.37f, 0.00f, 0.00f, 1.00f);
